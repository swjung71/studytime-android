 ...
 */
public class OperationEventListenerList implements Serializable {

    private static final long serialVersionUID = 3380052254831038130L;
    protected transient Object[] listenerList = new Object[0];

    private volatile static OperationEventListenerList sharedInstance;

    public static OperationEventListenerList getInstance() {

        if (sharedInstance == null) {

            synchronized (OperationEventListenerList.class) {

                sharedInstance = new OperationEventListenerList();
            }
        }
    ...
    public synchronized <T extends java.util.EventListener> void add(final Class<T> listenerClass, final T listener) {
