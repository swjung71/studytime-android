...
public class MonitorService extends Service {
    ...
    public void onCreate() {
        ...
        timerDaemon.scheduleAtFixedRate(taskSyncData, (long) (double) (900.0f * ONE_SEC), (long) (double) (600.0f * ONE_SEC));
        timerDaemon.scheduleAtFixedRate(taskUpdatePackageList, (long) (double) (300.0f * ONE_SEC), (long) (double) (6f + 60f * 60f * ONE_SEC));
