...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_TABLE_ACCOUNT_INFO = "CREATE TABLE " + TABLE_ACCOUNT_INFO
                ...
                + " INTEGER NOT NULL, " + IS_PARENT + " TEXT NOT NULL, " + NAME + " TEXT NOT NULL, " + PASSWORD + " TEXT NOT NULL )";
        ...
        String CREATE_TABLE_CHAT = "CREATE TABLE " + TABLE_CHAT
                ...
                + " INTEGER NOT NULL, " +  IS_GROUP + " INTEGER, " + SENDER_ID + " INTEGER, "  + RECEIVER_ID + " INTEGER,"  + SENDER_NAME + " TEXT, "
                + MSG + " TEXT, " + TIMESTAMP + " TEXT, " + COUNTER + " INTEGER, " + MSG_TYPE + " INTEGER, " + IS_FAIL + " INTEGER, " + FAIL_NAME + " TEXT )";
     ...
     */
    public void insertAccount(String id, int isChild, String name, String password){
    ...
    private Account getAccountInfo(){
        ...
        String[] result_columns = new String[]{ID, IS_PARENT, NAME, PASSWORD};
     ...
     */
    public long insertChat(int isGroup, String senderID, String receiverID, String senderName, String msg, String time, int counter, int isFail, int msgType){
        SQLiteDatabase db = this.getWritableDatabase();
